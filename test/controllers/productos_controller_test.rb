...
class ProductosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post productos_url, params: { producto: { codigo: @producto.codigo, imagen,: @producto.imagen,, nombre,: @producto.nombre,, tipo,: @producto.tipo, } }, as: :json
    end
  ...
  test "should update producto" do
    patch producto_url(@producto), params: { producto: { codigo: @producto.codigo, imagen,: @producto.imagen,, nombre,: @producto.nombre,, tipo,: @producto.tipo, } }, as: :json
    assert_response 200
  end
